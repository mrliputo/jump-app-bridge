...
export type JumpAuthErrorCode = 'E_NOT_CONFIGURED' | 'E_BIND_FAILED' | 'E_TIMEOUT' | 'E_PERMISSION' | 'E_REMOTE' | 'E_INVALID_RESPONSE' | 'E_UNAVAILABLE';
export declare class JumpAuthError extends Error {
